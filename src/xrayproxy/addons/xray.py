...
class XRayAddon:
    ...
    def __init__(self) -> None:
        ...
        self._mute_mobile_options: Optional[MobileUserAgentOptions] = None
    ...
    def configure(self, updated: set[str]) -> None:
        ...
        if "x_ray_config" in updated:
            ...
            self._mute_mobile_options = config.rewrite.mute_mobile_options
    ...
    async def response(self, flow: HTTPFlow) -> None:
        ...
        if (
            ...
            and is_mobile_user_agent(flow.request.headers.get("user-agent", ""), self._mute_mobile_options)
        ):
